...
export default function ConnectedAccounts({ user }: ConnectedAccountsProps) {
    ...
    return (
        <>
            ...
            {/* lexisort Email Provider Section */}
            <Column paddingX="24" paddingTop="24" fillWidth gap="16">
                <Row horizontal="space-between" vertical="center">
                    <Heading variant="heading-strong-s">lexisort Email Provider</Heading>
                ...
                >
                    <Column gap="16">
                        <Row gap="16" vertical="center">
                            ...
                            <Text variant="body-strong-m">
                                Use lexisort as your email provider
                            </Text>
                        </Row>
                        <Text variant="body-default-s">
                            Soon you'll be able to use lexisort as your primary email provider with
